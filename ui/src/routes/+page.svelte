            ...
            },
            {
                ...
                chartOptions: {
                    ...
                    stroke: {
                        ...
                        lineCap: "butt",
                        colors:
                            "rgba(" + appVariables.color.blackRgb + ", .25)",
                        width: 2,
                        dashArray: 0,
                    },
                    plotOptions: {
        ...
        serverData = {
            chartOptions: {
                ...
                grid: {
                    show: true,
                    borderColor:
                        "rgba(" + appVariables.color.inverseRgb + ", .15)",
                },
                stroke: { show: false },
            },
            stats: [
...
<h1 class="page-header">
    <img
        ...
        alt={currentCoin($availableCoins).name}
        src={currentCoin($availableCoins).image}
    />{currentCoin($availableCoins).name}
    <small class="text-uppercase">{currentCoin($availableCoins).symbol}</small>
</h1>
<!-- BEGIN row -->
<div class="row">
    <div class="col-xl-6">
                        ...
                        <div class="widget-chat">
                            ...
                            <div class="widget-chat-item">
                                ...
                                <div class="widget-chat-content">
                                    ...
                                    <div class="widget-chat-message last">
                                        Taraxa is a smart contract platform
                                        compatible with Ethereum Virtual Machine
                                        (EVM) and uses a t-Graph consensus
                                        mechanism incorporating blockDAG.
                                    </div>
                                </div>
                            </div>
                            <div class="widget-chat-item reply">
                            ...
                            <div class="widget-chat-item">
                                ...
                                <div class="widget-chat-content">
                                    ...
                                    <div class="widget-chat-message last">
                                        <p>
                                            Here&#39;s a simplified message
                                            outlining Taraxa&#39;s token
                                            distribution:
                                        </p>
                                        <hr />
                                        <p>
                                            <strong
                                                >Taraxa Token Distribution:</strong
                                            >
                                        </p>
                                        <ul>
                                            <li>
                                        ...
                                        <p>
                                            This allocation supports ecosystem
                                            development, rewards the community,
                                            incentivizes the team, and engages
                                            investors through sales.
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <CardBody>
                ...
                <div class="ratio ratio-21x9 mb-3">
                    {#if serverData && serverData.chartOptions}
                        <ApexCharts options={serverData.chartOptions}
                        ></ApexCharts>
                    {/if}
                </div>
                <div class="row">
