...
<h1 class="page-header">Privacy Policy <small>Last updated: April 29, 2024</small></h1>
<hr class="mb-5">
<Card>
    <div class="row gx-0">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to TRIXY.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to TRIXY, accessible from <a href="https://trixy.ai"
                                                                                            rel="external nofollow noopener"
                                                                                            target="_blank">https://trixy.ai</a>
                            </p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            <p>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                            data-cfemail="d1beb7b7b8b2b491a5a3b8a9a8ffb0b8">[email&#160;protected]</a>
                            </p>
                        </li>
                        <li>
                            <p>By visiting this page on our website: <a href="https://trixy.ai/contact-us"
                                                                        rel="external nofollow noopener"
                                                                        target="_blank">https://trixy.ai/contact-us</a>
                            </p>
                        </li>
                    </ul>
