...
<div class="app-theme-panel" class:active={active === 'true'}>
	<div class="app-theme-panel-container">
		<a href="#/" on:click|preventDefault={themePanelToggler} class="app-theme-toggle-btn"><i class="bi bi-sliders"></i></a>
				...
				<CardBody class="p-2">
					<div class="row gx-2">
						{#each modeList as mode}
							<div class="col-6">
								<a href="#/" on:click|preventDefault={() => themeModeToggler(mode.value)} class="app-theme-mode-link" class:active={mode.value == activeMode}>
				...
				<CardBody class="p-2">
					<div class="app-theme-list">
						...
						<div class="app-theme-list-item" class:active={theme.themeClass == activeTheme}>
							<a href="#/" class="app-theme-list-link {theme.bgClass}" on:click|preventDefault={() => themeColorToggler(theme.themeClass)} data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-container="body" data-bs-title="{theme.name}">&nbsp;</a></div>
						{/each}
					</div>
				</CardBody>
			</Card>
				...
				<CardBody class="p-2">
					...
					<div class="app-theme-cover">
						...
						<div class="app-theme-cover-item" class:active={cover.coverClass == activeCover}>
							<a href="#/" class="app-theme-cover-link" on:click|preventDefault={() => themeCoverToggler(cover.coverClass)} style="background-image: url({cover.coverThumbImage});" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-container="body" data-bs-title="{cover.name}">&nbsp;</a>
						</div>
						{/each}
					</div>
				</CardBody>
