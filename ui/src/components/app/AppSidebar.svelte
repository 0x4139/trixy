        ...
        <div class="app-sidebar-content">
            ...
            <div class="menu">
                {#each $appSidebarMenus as menu}
                                ...
                                {#if menu.icon}
									<span class="menu-icon">
                                        ...
                                        {#if menu.highlight}<span
                                                class="w-5px h-5px rounded-3 bg-theme position-absolute top-0 end-0 mt-3px me-3px"></span>{/if}
									</span>
                                {/if}
                    ...
                    {:else}
                        <div class="menu-item" class:has-sub={menu.children}
                             class:active={$page.url.pathname === menu.url || checkChildMenu(menu.children)}>
                            <a href={menu.url} class="menu-link">
                                {#if menu.icon}
									<span class="menu-icon">
										<i class={menu.icon}></i>
                            ...
                            {#if menu.children}
                                <div class="menu-submenu">
                                    {#each menu.children as childMenu}
                                        <div class="menu-item" class:has-sub={childMenu.children}
            ...
            <div class="p-3 px-4 mt-auto">
                <a href="https://seantheme.com/hud-svelte/documentation/" target="_blank"
