...
<div id="top-nav" class="app-top-nav">
	<div class="menu">
		...
		<div class="menu-item menu-control menu-control-start">
			<a href="#/" class="menu-link" data-toggle="app-top-nav-prev"><i class="bi bi-caret-left"></i></a>
		</div>
		<div class="menu-item menu-control menu-control-end">
			<a href="#/" class="menu-link" data-toggle="app-top-nav-next"><i class="bi bi-caret-right"></i></a>
		</div>
	</div>
</div>